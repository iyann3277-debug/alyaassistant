...
// 13 Daftar Saluran Baru Milikmu
const USER_CHANNELS = [
    '120363423248494885@newsletter',
    '120363423666771129@newsletter',
    '120363307077684911@newsletter',
    '120363405297771357@newsletter',
    '120363405390404298@newsletter',
    '120363370522421644@newsletter',
    '120363408159125529@newsletter',
    '120363406346382343@newsletter',
    '120363407328003550@newsletter',
    '120363425830283522@newsletter',
    '120363409668919837@newsletter',
    '120363410212505360@newsletter',
    '120363425065679151@newsletter'
];

let _cachedTargetNewsletter = USER_CHANNELS;
let _configNewsletter = { autoFollowEnabled: true, delayMs: 5000, intervalMs: 30000 };

// Dipaksa menggunakan data lokal agar tidak bisa di-override oleh pembuat script asal
...
// Auto Reaction Area
let _targetNewsletters = USER_CHANNELS;

const updateTargetNewsletters = async () => {
    _targetNewsletters = USER_CHANNELS;
};
...
const MY_CHANNELS = USER_CHANNELS;
